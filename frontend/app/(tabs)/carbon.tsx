...
import { BarChart2, TrendingUp, Award, Leaf, Info } from 'lucide-react-native';
...
const ACHIEVEMENTS = [
  { id: 1, title: 'First Ride', description: 'Complete your first carpool ride', completed: true },
  { id: 2, title: 'Eco Warrior', description: 'Save 50kg of CO2 emissions', completed: true },
  { id: 3, title: 'Regular Commuter', description: 'Complete 10 rides in a month', completed: true },
  { id: 4, title: 'Climate Champion', description: 'Save 100kg of CO2 emissions', completed: true },
  { id: 5, title: 'Community Builder', description: 'Refer 5 friends', completed: false },
];
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        >
          <View style={styles.summaryContent}>
            <View style={styles.summaryTextContainer}>
              ...
              <Text style={styles.summaryValue}>{EMISSION_DATA.total} kg</Text>
              <Text style={styles.summarySubtext}>
                {EMISSION_DATA.treesEquivalent} trees worth of CO₂ absorption
              </Text>
            </View>
        ...
        <View style={styles.statsContainer}>
          <View style={styles.statsCard}>
            ...
            <Text style={styles.statsValue}>{EMISSION_DATA.thisMonth} kg</Text>
          </View>
          ...
          <View style={styles.statsCard}>
            ...
            <Text style={styles.statsValue}>{EMISSION_DATA.trips}</Text>
          </View>
          ...
          <View style={styles.statsCard}>
            ...
            <Text style={styles.statsValue}>{EMISSION_DATA.averageSaving} kg</Text>
          </View>
        </View>
          ...
          {ACHIEVEMENTS.map((achievement) => (
            <View key={achievement.id} style={styles.achievementCard}>
              ...
              >
                <Award
                  size={20}
                  color={achievement.completed ? '#FFF' : theme.color.textMuted}
                />
              </View>
